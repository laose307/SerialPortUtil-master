...
/**
        * 阻塞式不开线程即调即返回
        */
public class SerialPortSyncService implements ISerialPortService {
     ...
     */
    public SerialPortSyncService(String devicePath, int baudrate, Long timeOut) throws IOException {
        mTimeOut = timeOut;
    ...
    public byte[] sendData(byte[] data) {
        synchronized (SerialPortSyncService.this) {
            try {
