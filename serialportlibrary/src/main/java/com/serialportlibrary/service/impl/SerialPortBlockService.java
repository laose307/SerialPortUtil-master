...
/**
        * 阻塞式不开线程即调即返回
        */
public class SerialPortBlockService implements ISerialPortService {
     ...
     */
    public SerialPortBlockService(String devicePath, int baudrate, Long timeOut) throws IOException {
        mTimeOut = timeOut;
    ...
    public byte[] sendData(byte[] data) {
        synchronized (SerialPortBlockService.this) {
            try {
    ...
    @Override
    public byte[] sendDataHex(String data) {
        return new byte[0];
    }
